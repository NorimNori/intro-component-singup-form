...
const Form = () => {
  ...
  const emailRegex =
    /^[^\s@]+@(gmail|hotmail|yahoo|outlook|live|icloud|aol|protonmail|zoho|yandex)\.com$/i;
      ...
      >
        ...
        {submittedEmail && (
          <p className="form__success-message">
            Form successfully submitted to <strong>{submittedEmail}</strong>
          </p>
        )}
        ...
        <p id="form-terms" className="form__terms">
          ...
          <a href="#" className="form__terms-highlight">
            Terms and Services
          </a>
        </p>
      </form>
